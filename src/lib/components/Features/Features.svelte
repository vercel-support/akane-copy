   ...
   <div class="relative">
     <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
       <div class="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
         <div>
           <div>
             <span class="h-12 w-12 rounded-xl flex items-center justify-center bg-primary">
           ...
           <div class="mt-6">
             <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">Crea tu identidad</h2>
             <p class="mt-4 text-lg text-gray-500">Una identidad hecha a tu medida. Todo lo que necesitas para diferenciarte de la competencia</p>
             <div class="mt-6 flex gap-8">
               <Button text="Ver Oferta" variant="primary"></Button>
               <Button text="Ver Portfolio" variant="secondary"></Button>
             </div>
           </div>
         </div>
     ...
     <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
       <div class="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
         <div>
           ...
           <div class="mt-6">
             <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">Crea tu sitio web profesional</h2>
             <p class="mt-4 text-lg text-gray-500">Un sitio que se adecue a tus necesidades y a las de tus clientes, con estrategias, contenido, diseño y desarrollo profesional</p>
             <div class="mt-6 flex gap-8">
               <Button text="Ver Oferta" variant="primary"></Button>
               <Button text="Ver Portfolio" variant="secondary"></Button>
             </div>
